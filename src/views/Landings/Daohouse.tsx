  ...
  return (
    <Page>
      ...
      <Container>
        ...
        <Spacer />
        <span>
        Aptoselon’s first Elon House implementation is named elonHOUSE, the Treasury Management Solution governed by the aptoselon DAO community with an investment strategy selected via an on-chain vote by the Aptoselon community.
