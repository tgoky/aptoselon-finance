      ...
      <StyledCard>
        ...
        <CardContent>
          <Box alignItems="center" column minHeight={125} maxHeight={125}>
            <ValueText value="aptoselon Re-Org" />
            <Label text="Aptoselon's Re-Org is designed to attract talented builders while giving token holders full control." labelPosition="center" />
          </Box>
        </CardContent>
        <CardActions>
          <Button
