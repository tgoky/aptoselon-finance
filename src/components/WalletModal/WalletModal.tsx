  ...
  return (
    <Modal isOpen={isOpen} onDismiss={onDismiss}>
      ...
      <ModalContent>
        <Split>
          <Box row>
            <FancyValue icon="👨‍🚀🚀" label="APTELON balance" value={getDisplayBalance(yamV3Balance)} />
          </Box>
          <Box row>
            <FancyValue
              icon={
        ...
        <Split>
          <Box row>
            <FancyValue icon="🎁" label="Vested APTELON (Delegator)" value={getDisplayBalance(vestedDelegatorRewardBalance)} />
          </Box>
          <Box row>
            <FancyValue icon="🦋" label="Vested APTELON (Migrated)" value={getDisplayBalance(vestedMigratedBalance)} />
          </Box>
        </Split>
        <Spacer />
      </ModalContent>
